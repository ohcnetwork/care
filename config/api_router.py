...
from care.facility.api.viewsets.patient import PatientAdmissionViewSet, PatientViewSet
...
facility_nested_router.register(r"patient", PatientAdmissionViewSet)
