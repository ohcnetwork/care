...
from care.facility.api.viewsets.consultation_symptoms import ConsultationSymptomsViewset
...
consultation_nested_router.register(r"symptoms", ConsultationSymptomsViewset)
