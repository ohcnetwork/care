...
TASK_SUMMARIZE_TRIAGE_DISABLED = env("TASK_SUMMARIZE_TRIAGE_DISABLED", default="")
TASK_SUMMARIZE_TESTS_DISABLED = env("TASK_SUMMARIZE_TESTS_DISABLED", default="")
TASK_SUMMARIZE_FACILITY_CAPACITY_DISABLED = env("TASK_SUMMARIZE_FACILITY_CAPACITY_DISABLED", default="")
TASK_SUMMARIZE_PATIENT_DISABLED = env("TASK_SUMMARIZE_PATIENT_DISABLED", default="")
TASK_SUMMARIZE_DISTRICT_PATIENT_DISABLED = env("TASK_SUMMARIZE_DISTRICT_PATIENT_DISABLED", default="")
