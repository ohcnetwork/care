...
PRODUCT_ADDITIONAL_METADATA_JSON_SCHEMA = env.json(
    "PRODUCT_ADDITIONAL_METADATA_JSON_SCHEMA",
    default={},
)

SUPPLY_DELIVERY_ADDITIONAL_METADATA_JSON_SCHEMA = env.json(
    "SUPPLY_DELIVERY_ADDITIONAL_METADATA_JSON_SCHEMA",
    default={},
)

SUPPLY_DELIVERY_ORDER_ADDITIONAL_METADATA_JSON_SCHEMA = env.json(
    "SUPPLY_DELIVERY_ORDER_ADDITIONAL_METADATA_JSON_SCHEMA",
    default={},
)
