...
from care.security.roles.role import STAFF_ROLE, DOCTOR_ROLE


class FacilityPermissions(enum.Enum):
    can_read_facility = Permission("Can Read on Facility", "Something Here", PermissionContext.FACILITY, [STAFF_ROLE , DOCTOR_ROLE])
