...
class ConsultationPrescriptionViewSet(
    ...
    def upsert(self, request, *args, **kwargs):
        ...
        for prescription in data["prescriptions"]:
            ...
            prescription_obj = Prescription.objects.get(consultation=consultation, external_id=id)
            prescription_serializer = PrescriptionSerializer(prescription_obj, data=prescription, partial=True)
