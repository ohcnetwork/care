        ...
        for patient_note in paginator.page(page_number).object_list:
            ...
            note_thread, _ = NoteThread.objects.get_or_create(
                ...
                defaults={
                    ...
                    "created_by_id": patient_note.created_by_id or fallback_care_user.id,
                    "updated_by_id": patient_note.created_by_id or fallback_care_user.id,
                },
            )
            history = []
            for edit in patient_note.edits.all():
                if patient_note.note == edit.note:
                    ...
                    continue
                editor = edit.edited_by or fallback_care_user
                history.append(
                    {
                        "message": edit.note,
                        "created_by": {
                            "username": editor.username,
                            "external_id": str(editor.external_id),
                        },
