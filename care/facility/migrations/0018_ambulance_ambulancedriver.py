    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vehicle_number', models.CharField(db_index=True, max_length=20, unique=True, validators=[django.core.validators.RegexValidator(code='invalid_mobile', message='Please Enter the vehicle number in all uppercase without spaces, eg: KL13AB1234', regex='^[A-Z]{2}[0-9]{1,2}[A-Z]{1,2}[0-9]{1,4}$')])),
                ...
                ('secondary_district', models.IntegerField(blank=True, choices=[(1, 'Thiruvananthapuram'), (2, 'Kollam'), (3, 'Pathanamthitta'), (4, 'Alappuzha'), (5, 'Kottayam'), (6, 'Idukki'), (7, 'Ernakulam'), (8, 'Thrissur'), (9, 'Palakkad'), (10, 'Malappuram'), (11, 'Kozhikode'), (12, 'Wayanad'), (13, 'Kannur'), (14, 'Kasaragod')], null=True)),
                ('third_district', models.IntegerField(blank=True, choices=[(1, 'Thiruvananthapuram'), (2, 'Kollam'), (3, 'Pathanamthitta'), (4, 'Alappuzha'), (5, 'Kottayam'), (6, 'Idukki'), (7, 'Ernakulam'), (8, 'Thrissur'), (9, 'Palakkad'), (10, 'Malappuram'), (11, 'Kozhikode'), (12, 'Wayanad'), (13, 'Kannur'), (14, 'Kasaragod')], null=True)),
