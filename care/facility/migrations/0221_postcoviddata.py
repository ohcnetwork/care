# Generated by Django 2.2.11 on 2021-04-20 08:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('antivirals_drugs', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=100), blank=True, default=list, null=True, size=None)),
                ('steroids', models.BooleanField(default=False, null=True)),
                ('steroids_drugs', django.contrib.postgres.fields.ArrayField(base_field=django.contrib.postgres.fields.jsonb.JSONField(default=dict), blank=True, default=list, null=True, size=None)),
                ('anticoagulants', models.BooleanField(default=False, null=True)),
                ('anticoagulants_drugs', django.contrib.postgres.fields.ArrayField(base_field=django.contrib.postgres.fields.jsonb.JSONField(default=dict), blank=True, default=list, null=True, size=None)),
                ('antibiotics', models.BooleanField(default=False, null=True)),
                ('antibiotics_drugs', django.contrib.postgres.fields.ArrayField(base_field=django.contrib.postgres.fields.jsonb.JSONField(default=dict), blank=True, default=list, null=True, size=None)),
                ('antifungals', models.BooleanField(default=False, null=True)),
                ('antifungals_drugs', django.contrib.postgres.fields.ArrayField(base_field=django.contrib.postgres.fields.jsonb.JSONField(default=dict), blank=True, default=list, null=True, size=None)),
