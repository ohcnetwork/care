# Generated by Django 2.2.11 on 2021-04-25 11:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('covid_category', models.CharField(choices=[('Mild', 'MILD'), ('Moderate', 'MODERATE'), ('Severe', 'SEVERE')], max_length=15)),
                ...
                ('oxygen_requirement_detail', models.CharField(choices=[('Nasal prongs', 'NASAL_PRONGS'), ('Face mask', 'FACE_MASK'), ('Nrbm', 'NRBM'), ('Fno', 'FNO')], default=care.facility.models.post_covid_data.OxygenType('Nasal prongs'), max_length=15)),
