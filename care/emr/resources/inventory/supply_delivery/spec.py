...
class SupplyDeliveryWriteSpec(ExtensionValidator, BaseSupplyDeliverySpec):
    ...
    supplied_item_pack_quantity: int | None = Field(None, ge=1)
    supplied_item_pack_size: int | None = Field(None, ge=1)

    supplied_item_quantity: Decimal = Field(max_digits=20, decimal_places=0, ge=1)
