...
# --- Edges into the Patient context -----------------------------------------
...
# --- Patient values ----------------------------------------------------------
# Plain scalars only: an expression compares them with `==`, `>` and friends,
# so dates go out as ISO strings (they order lexicographically) and the
# deceased flag as a boolean rather than a datetime.
