# Generated by Django 2.2.11 on 2020-05-22 10:17

import apps.patients.mixins
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('suggestion', models.CharField(choices=[(0, 'HOME ISOLATION'), (1, 'ADMISSION'), (2, 'REFERRAL')], max_length=3)),
            ...
            bases=(apps.patients.mixins.PatientRelatedPermissionMixin, models.Model),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            bases=(apps.patients.mixins.PatientPermissionMixin, models.Model),
        ),
        migrations.CreateModel(
            name='PatientSample',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='patients.PatientRegistration')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='patientsample',
            name='patient',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='patients.PatientRegistration'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='patient',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='contacted_patients', to='patients.PatientRegistration'),
        ),
        migrations.AddField(
            model_name='patientcontactdetails',
            name='patient_in_contact',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='contacts', to='patients.PatientRegistration'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='patientconsultation',
            name='patient',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='patients', to='patients.PatientRegistration'),
        ),
        migrations.AddField(
            model_name='patientconsultation',
            name='referred_to',
        ...
        migrations.AddField(
            model_name='disease',
            name='patient',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='medical_history', to='patients.PatientRegistration'),
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            bases=('patients.patientregistration',),
        ),
        migrations.CreateModel(
            ...
            bases=('patients.patientsample',),
        ),
        migrations.AddConstraint(
            model_name='patientconsultation',
            constraint=models.CheckConstraint(check=models.Q(models.Q(_negated=True, suggestion=2), ('referred_to__isnull', False), _connector='OR'), name='if_referral_suggested'),
        ),
        migrations.AddConstraint(
            model_name='patientconsultation',
        ...
        migrations.AddIndex(
            model_name='disease',
            index=partial_index.PartialIndex(fields=['patient', 'disease'], name='patients_di_patient_0e5121_partial', unique=True, where=partial_index.PQ(deleted=False)),
        ),
    ]
